...
export default function CustomFooter() {
  ...
  return (
    <footer className="w-screen" >
      ...
      <div className="bg-[#015d9c] lg:overflow-hidden relative footer text-white lg:h-[85vh]  w-full lg:py-2 py-20 md:py-20  lg:px-[100px] md:px-5 sm:px-3 ">
        ...
        <div className="flex  w-full py-10 lg:py-[90px] lg:mb-0 mb-5 ">
